...
# sonuc = (sayi1 > sayi2) #gelecek değer True veya False olacak
# print(f'{sayi1} {sayi2} den büyüktür: {sonuc}')

# 2- Girilen bir sayının tek mi çift mi olduğunu yazdırın.
# sayi = int(input("sayi: "))

# sonuc = (sayi % 2 == 0) #0 dersek çift mi 1 dersek tek mi olarak sormuş oluruz
...
# sonuc = (sayi > 0) # ise sonuç pozitif
